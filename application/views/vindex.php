			...
			<div class="ubea-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center ubea-heading">
						...
						<p class="center">
							Nosotros te entendemos y nos encargamos de responder a tus
							dudas acerca de c&oacute;mo usar &eacute;ste sistema, gracias
							por brindarnos tu confianza.
						</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-6">
						...
						<div class="ubea-accordion">
							<div class="ubea-accordion-heading">
								<div class="icon"><i class="icon-cross"></i></div>
								<h3>¿Necesito registrarme para usar el sistema?</h3>
							</div>
							<div class="ubea-accordion-content">
								<div class="inner">
					...
					<div class="col-md-6">
						...
						<div class="ubea-accordion">
							...
							<div class="ubea-accordion-content">
								<div class="inner">
										<p class="justify">¡Absolutamente!</p>
								</div>
							</div>
						</div>
